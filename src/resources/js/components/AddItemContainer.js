    ...
    return <form onSubmit={handleSubmit}>
        <div id="fields">
            <div className="input-container">
                ...
                <input required name="title" title="A title is required" onChange={() => props.setAddWarning(null)}/>
            </div>
            <div className="input-container">
                <label htmlFor="author">Author</label>
                <input required name="author" title="An author is required" onChange={() => props.setAddWarning(null)}/>
            </div>
        </div>
